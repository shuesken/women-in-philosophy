...
const data = {
    ...
    pie: {
        labels: ["Original (Women)", "Discussion (Women)", "Original (Men)", "Discussion (Men)", "Unknown (Women)", "Unknown (Men)"],
        colors: ["#9ecae1","#deebf7","#e19e9e","#f7dede","#0000de","#de0000"],
        values:{
            '1954-1955': [null,null,null,null,17,343] ,
            '1974-1975': [null,null,null,null,39,353] ,
            '1994-1995': [null,null,null,null,32,246] ,

            '2004':[107,41,577,298,null,null],
            '2014':[179,88,1013,361,null,null],
            '2015':[158,97,873,432,null,null]
        },
        totalPercent: {
            '1954-1955': 5 ,
            '1974-1975': 10 ,
    ...
    journals: {
        ...
        values: {
            all: {
                '1954-1955': [null, null, null, null, null, null, null, 2.6, null, null, 8.6, null, 2.3, null, null, null, null, null, 3.1, null, null, null, null, null, null, ],
                '1974-1975': [null, null, null, null, null, null, null, 19.8, null, null, 10.5, null, 9.3, null, null, null, null, null, 3.1, null, null, 7.6, null, null, null, ],
                '1994-1995': [null, null, null, null, null, null, null, 18.3, null, null, 13.9, null, 7.0, null, null, null, null, null, 10.8, null, null, 11.9, null, null, null, ],
            ...
            original: {
                '1954-1955': [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, ],
                '1974-1975': [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, ],
                '1994-1995': [null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, ],
...
function selectJournalDecade(decade, type, sorting) {
    ...
    jointArray = jointArray.sort((a, b) => (a[sorting] - b[sorting]) )
    if(reverse) jointArray = _.reverse(jointArray);

    jointArray.forEach( s => {
...
export default function(props) {
    ...
    const [journalDecade, setJournalDecade] = useState(selectJournalDecade(2015, "all", "value"));
    ...
    function updateSelection(e){;
        ...
        if ( e.target.name === "decade") {
            d = ['1954-1955', '1974-1975', '1994-1995', '2004', '2014', '2015'][e.target.value];
            setDecade(d);
        }
    ...
    return <Layout>
        ...
        <input className="slider" type="range" id="decade" name="decade" min="0" max="5" defaultValue={5} onChange={updateSelection}/>


        <br/><br/>

        <h2>Methods</h2>
        <strong>1954-1995: Schwitzgebel and Jennings</strong>
