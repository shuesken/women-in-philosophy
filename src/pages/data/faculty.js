...
function selectFacultyData(decade, sorting, reverse) {
    let jointArray = []
    var i = 0
...
export default function(props) {
    ...
    const [facultyYear, setFacultyYear] = useState(selectFacultyData(2019, 'rank'));
    ...
    function updateSelection(e){
        ...
        setFacultyYear(selectFacultyData(y, s, reverse))
    }
